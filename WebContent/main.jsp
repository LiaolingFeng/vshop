...
<%@ taglib prefix="time" uri="http://www.jikexueyuan.com/tags/timestamp"%>
<%
				...
				<li>
					<table border="0" width="100%">
						...
						<tr>
							<td align="center">
								<!-- 使用EL自定义的函数 -->
								${time:fmtTimeStamp(current_user.created_time,"yyyy-MM-dd")}
							</td>
						</tr>
						<tr>
							<td align="center">(<fmt:formatNumber type="number"
									value="${(current_user.right_num-current_user.left_num-1)/2 }"></fmt:formatNumber>-${time:getMoney(current_user.right_num,current_user.left_num)})
							</td>
						</tr>
					</table>
					<ul>
						<li>
							<table border="0" width="100%" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td align="center"><c:if test="${user_1 ne null}">
											<a href="<%=path%>/main.do?user=${user_1.user_id}">${user_1.user_id }</a>
										</c:if> <c:if test="${user_1 eq null}">
											<a href="add.jsp">推荐</a>
										</c:if></td>
								</tr>
								<tr>
									<td align="center"><time:timestamp
											timestamp="${user_1.created_time }" format="yyyy-MM-dd" /></td>
								</tr>
								<tr>
									<td align="center"><c:if test="${user_1 ne null}">
								...
								<tr>
									...
									(<fmt:formatNumber type="number"
												value="${(user_1.right_num - user_1.left_num -1 )/2 }"></fmt:formatNumber>)
									</c:if></td>
								</tr>
						...
						<li>
							<table border="0" width="100%" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td align="center"><c:if test="${user_2 ne null}">
											<a href="<%=path%>/main.do?user=${user_2.user_id}">${user_2.user_id }</a>
										</c:if> <c:if test="${user_2 eq null}">
											<a href="add.jsp">推荐</a>
										</c:if></td>
								</tr>
								<tr>
									<td align="center"><time:timestamp
											timestamp="${user_2.created_time }" format="yyyy-MM-dd" /></td>
								</tr>
								<tr>
									<td align="center"><c:if test="${user_2 ne null}">
								...
								<tr>
									<td align="center"><c:if test="${user_2 ne null}">
									(<fmt:formatNumber type="number"
												value="${(user_2.right_num - user_2.left_num -1 )/2 }"></fmt:formatNumber>)
									</c:if></td>
								</tr>
							</table>
							<ul>
						...
						<li>
							<table border="0" width="100%" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td align="center"><c:if test="${user_3 ne null}">
											<a href="<%=path%>/main.do?user=${user_3.user_id}">${user_3.user_id }</a>
										</c:if> <c:if test="${user_3 eq null}">
											<a href="add.jsp">推荐</a>
										</c:if></td>
								</tr>
								<tr>
									<td align="center"><time:timestamp
											timestamp="${user_3.created_time }" format="yyyy-MM-dd" /></td>
								</tr>
								<tr>
									<td align="center"><c:if test="${user_3 ne null}">
								...
								<tr>
									<td align="center"><c:if test="${user_3 ne null}">
									(<fmt:formatNumber type="number"
												value="${(user_3.right_num - user_3.left_num -1 )/2 }"></fmt:formatNumber>)
									</c:if></td>
								</tr>
							</table>
							<ul>
