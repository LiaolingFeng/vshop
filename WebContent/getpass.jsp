...
<body>
	 <img id="bg" src="images/adminlogin.png" width="100%" height="100%"
	  style="right: 0; z-index:-1;position: absolute; top: 0;" >   
	<div class="wrapper">
		<form action="updatepass.jsp" method="post">
			<div class="admin_login_main">
				<div class="admin_login_logo" style="height: 130px;">分销管理系统</div>
				<div
